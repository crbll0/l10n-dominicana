...
class AccountMove(models.Model):
    ...
    def _compute_name(self):
        others_move = self.filtered(lambda x: x.country_code != "DO" or
                                            x.move_type not in ('out_refund', 'out_invoice', 'in_refund', 'in_invoice'))
        l10n_do_move = self - others_move
        ...
        self = l10n_do_move.sorted(lambda m: (m.date, m.ref or "", m.id))
